...
private let API_KEY = "6eb76893075642ec5587571c52649d8b"
...
private func makeDataRequest(forCoordincates coordinates: CLLocationCoordinate2D) {
...
extension WeatherService: CLLocationManagerDelegate {
    public func locationManager(
        ...
        makeDataRequest(forCoordincates: location.coordinate)
    }
